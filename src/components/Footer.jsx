    ...
    <footer className="border-t border-slate-100 bg-white/80 backdrop-blur">
      <div className="mx-auto grid max-w-6xl gap-6 px-6 py-8 text-sm text-slate-600 md:grid-cols-4">
        <div className="space-y-2">
          ...
          <p>Mock data: 10 sản phẩm L’Oréal Paris, 80 bài blog (clean beauty, lifestyle).</p>
        </div>
        ...
        <div className="space-y-3">
          ...
          <p className="font-semibold text-slate-800">hello@glowandblog.mock</p>
          <div className="flex gap-3 text-sm font-semibold text-rose-600">
            <span className="cursor-pointer hover:text-rose-700">Instagram</span>
            <span className="cursor-pointer hover:text-rose-700">Facebook</span>
            <span className="cursor-pointer hover:text-rose-700">TikTok</span>
          </div>
        </div>
      </div>
